...
namespace Sakura.Tools.Aoe2FontGenerator.Utilities
{
	...
	public static class ResourceUtility
	{
		...
		public static T FindResource<T>(this FrameworkElement element, object key)
		{
		...
		{
			return element.FindResource<string>(key);
		}
		...
		{
			return application.FindResource<string>(key);
		}

		/// <summary>
		///     Find the string format resource with the specified <paramref name="key" /> and use format arguments to generate the
		///     entire string.
		/// </summary>
		/// <param name="element">The <see cref="FrameworkElement" /> object.</param>
		/// <param name="key">The key of the resource.</param>
		...
		/// <summary>
		///     Find the string format resource with the specified <paramref name="key" />. This method does not provide additional
		///     formatting arguments.
		/// </summary>
		/// <param name="element">The <see cref="FrameworkElement" /> object.</param>
		/// <param name="key">The key of the resource.</param>
		/// <returns>The formatted string.</returns>
		public static string FormatResString(this FrameworkElement element, object key)
		{
			return element.FindResString(key);
		}
		...
		/// <param name="key">The key of the resource.</param>
		/// <returns>The formatted string.</returns>
		public static string FormatResString(this Application application, object key)
		{
			return application.FindResString(key);
		}
